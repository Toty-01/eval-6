...
?>
<br>
<h2>Modification de la planque</h2>
...
<div class="d-flex justify-content-center" >
    ...
    <?php if(isset($error)) : ?>
        ...
        <div class="my-3">
            ...
            <input type="text" class="form-control" id="codeName" name="codeName" value="<?= $_POST['codeName'] ?? $hideout->getCodeName(); ?>" minlength="2" maxlength="50" required>
        </div>
        <div class="my-3">
            <p id="errorAddress" class="mb-3 error-msg"></p>
            <label for="address" class="form-label">Adresse</label>
            <input type="text" class="form-control" name="address" id="address" value="<?= $_POST['address'] ?? $hideout->getAddress(); ?>" minlength="2" maxlength="150" required>
        </div>
        <div class="my-3">
            ...
            <?php foreach($countryArray as $clef => $valeur){  ?>
                <option value="<?= $clef ?>" 
                    <?php if(isset($_POST['codeCountry'])){ 
                        ...
                        if($hideout->getCodeCountry() === $clef){ 
                            echo "selected"; 
                        }
                    }?>
                ><?= $valeur ?></option>
        ...
        <div class="my-3">
            ...
            <input type="text" class="form-control" name="type" id="type" value="<?= $hideout->getType(); ?>" minlength="2" maxlength="30" required>
        </div>
...
$preContent = "";
$titleHead = "modification planque";
$src = URL . "script.js";
