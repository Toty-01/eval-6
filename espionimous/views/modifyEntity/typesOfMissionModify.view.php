...
?>
<br>
<h2>Modification du type de mission</h2>
...
<div class="d-flex justify-content-center" >
    ...
    <?php if(isset($error)) : ?>
        ...
        <p id="errorName" class="mb-3 error-msg"></p>
            ...
            <input type="text" class="form-control" id="name" name="name" value="<?= $_POST['name'] ?? $type->getName(); ?>" minlength="2" maxlength="50" required>
        </div>
...
$preContent = "";
$titleHead = "modification type de missions";
$src = URL . "script.js";;
